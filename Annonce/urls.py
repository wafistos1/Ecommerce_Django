...
from .views import  home, add_annonce, annonceDetailView, AnnonceDeletelView, updateAnnonce

urlpatterns = [
    path('', home, name='home'),
    path('annonce/add', add_annonce, name='add_annonce'),
    path('annonce/detail/<uuid:pk>', annonceDetailView, name='annonce_detail'),
    ...
    path('annonce/update/<uuid:pk>', updateAnnonce, name='annonce_update'),
]